...
int main() {
        ...
        double p[L1],p1,p0,pot[L1],Es[L1],Va,gamaN=1,CN,mu,E0,Zf[L1],Zb[L1],Pn[L1],O[L1],Zfsum,Zbsum,pOx,pdO[Ns],GN0,sumG,dg,mh[9];
        ...
        //mh[0]=-2; mh[1]=-0; mh[2]=2; mh[3]=4; mh[4]=6; mh[5]=8; mh[6]=10; mh[7]=15; mh[8]=20;
       ...
       for(h=-250;h<250;h=h+2) {  
          ...
          for(w=0;w<500;w=w+2) {
              ...
              //printf("mu loop....mu %lf E0 %lf pO %lf dg %lf lm %lf O %lf h %ld w %ld \n",mu,E0,pO,dg,lm,(Osum/L1),h,w);
              if(dg>164.5 && dg<165.5 && (Osum/L1)>0.7 && (Osum/L1)<0.9 && pO>40.54) {
                 printf("Ok... mu %lf E0 %lf pO %lf dg %lf lm %lf O %lf h %ld w %ld \n",mu,E0,pO,dg,lm,(Osum/L1),h,w);
              }
           } 
           //printf("ZfL %lf nuc %ld ksm %ld pO %lf dg %lf lm %lf O %lf pk %ld h %ld w %ld \n",Zf[L-1],nuc,ksm,pO,dg,lm,(Osum/L1),pk,h,w);  
        }
        fclose(f4); return(0); 
}
