...
int main() {
        FILE *f2,*f10,*f11,*f12;
        long int i,i1,i2,i3,j,k,dx,ks[2],l=91,L=L1,dw0,sze,sze1,soft[1000][3],nuc,ksm,ks1,t,w[n1],b1[n1],b2[n1],b3,hc1,hc2,cen[n1],h[n1],Nsim,b1in,b1out,b2in,b2out,a,amin;
        ...
        i=0; amin=91;               
        Va=0;ks[0]=91;ks[1]=17; nuc=91-amin+1; a=0; ksm=amin+a; nuc=1;            
        for(i=0;i<nuc;i++) {
           soft[i][0]=amin+i; soft[i][1]=91-soft[i][0]; soft[i][2]=0; frag[i]=0; frag1[i]=0; frag4[i]=0;
        }    
        soft[0][0]=91;        
        for(i=0;i<2000;i++) {
        ...
        mu=-15.0; CN=exp(mu); E0=0.034; Nsim=1;  //E0=10.0/(147-91);  E0=-(mu-1-log(1.0/91.0))/91.0;
        for(i1=0;i1<Nsim;i1++) {                                                       
           for(i=0;i<L1;i++) {
              for(t=0;t<nuc;t++) { 
                 Eij[i][t]=0; 
